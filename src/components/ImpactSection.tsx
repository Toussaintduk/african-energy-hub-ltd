...
const ImpactSection = () => (
  <section id="impact" className="py-24 bg-energy-dark text-primary-foreground relative overflow-hidden">
    ...
    <div className="container relative z-10">
      <div className="text-center mb-16">
        ...
        <p className="text-primary-foreground/70 mt-4 max-w-2xl mx-auto">Supporting Rwanda Vision 2050, SDGs 7, 9 & 11, and sustainable development across East Africa.</p>
      </div>
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {impacts.map(i => (
          <div key={i.label} className="text-center p-6 rounded-xl border border-primary-foreground/10 hover:border-primary-foreground/25 transition-colors">
            ...
            <p className="font-medium text-sm text-primary-foreground/90">{i.label}</p>
          </div>
        ))}
      </div>
    </div>
