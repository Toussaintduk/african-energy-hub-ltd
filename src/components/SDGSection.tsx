  ...
  <section id="sdg" className="py-24 bg-background">
    <div className="container">
      ...
      <div className="text-center mb-16">
        <span className="text-primary font-semibold text-sm uppercase tracking-wider">Global Impact</span>
        <h2 className="text-3xl md:text-4xl font-display font-bold mt-3">SDG Alignment</h2>
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-24">
        {sdgs.map(s => (
          <div key={s.num} className="relative bg-card rounded-2xl p-8 shadow-card border border-border overflow-hidden group hover:shadow-elevated transition-all">
            ...
            <span className="text-primary font-display font-bold text-sm">SDG {s.num}</span>
            <h3 className="font-display font-bold text-xl mt-1 mb-3">{s.title}</h3>
      ...
      {/* Rwanda Alignment */}
      <div className="text-center mb-16">
        <span className="text-primary font-semibold text-sm uppercase tracking-wider">National Development</span>
        <h2 className="text-3xl md:text-4xl font-display font-bold mt-3">Aligned with Rwanda Vision 2050 & NST2</h2>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
        {rwandaGoals.map(g => (
          <div key={g.title} className="flex gap-4 bg-card rounded-xl p-6 shadow-card border border-border hover:shadow-elevated transition-shadow">
            ...
            <div>
              <h4 className="font-display font-bold text-sm mb-1">{g.title}</h4>
