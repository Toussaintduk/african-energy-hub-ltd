...
const SDGSection = () => (
  <section id="sdg" className="py-24 bg-energy-dark">
    <div className="container">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-primary-foreground/60 mt-4 max-w-2xl mx-auto">Our work directly contributes to the United Nations Sustainable Development Goals.</p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-24">
        {sdgs.map(s => (
          <div key={s.num} className="relative bg-primary-foreground/5 backdrop-blur rounded-2xl p-8 border border-primary/20 overflow-hidden group hover:border-secondary/40 transition-all">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-primary-foreground/60 mt-4 max-w-2xl mx-auto">We actively support Rwanda's national transformation strategy through reliable energy infrastructure.</p>
      </div>
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
        {rwandaGoals.map(g => (
          <div key={g.title} className="flex gap-4 bg-primary-foreground/5 backdrop-blur rounded-xl p-6 border border-primary/20 hover:border-secondary/40 transition-all">
            ...
            <div>
              ...
              <p className="text-primary-foreground/60 text-sm leading-relaxed">{g.desc}</p>
            </div>
          </div>
        ))}
      </div>
